...
describe('maxStreakWeeks', () => {
  it('devuelve la racha más larga de semanas cumplidas (mínimo 3 sesiones)', () => {
    const workouts = [
      workout(1, '2026-01-05'),
      workout(2, '2026-01-07'),
      workout(3, '2026-01-09'),
      workout(4, '2026-01-12'),
      workout(5, '2026-01-14'),
      workout(6, '2026-01-16'),
    ]
    // Semana del 5-11 y del 12-18: ambas con 3 sesiones → 2 semanas consecutivas.
    expect(maxStreakWeeks(workouts)).toBe(2)
  })
})
