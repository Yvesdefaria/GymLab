...
### [x] Fase 69 — Comparación de sesiones (rediseño) (PENDIENTE menor: calorías)
...
- [ ] Calorías por sesión ← **no existe el dato persistido**: ni `Workout` ni `WorkoutSet` tienen kcal y `CardioTracker` las descarta al cerrar la serie; requiere modelar MET por ejercicio + `durationSeconds` + peso corporal
- [x] Keys es/en + `tsc` + build + tests + CHANGELOG + commit
