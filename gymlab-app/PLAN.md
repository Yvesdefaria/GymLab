...
#### [ ] #11 — 1RM independiente del ejercicio (F29/OneRepMax) *[estado: EN CURSO — opción A+B aprobada por usuario; Parte A CERRADA (2026-09-04); Parte B pendiente]*
...
- [ ] `tsc` + `build` + lint + CHANGELOG + commit (Parte B) al implementar la OPCIÓN B.
