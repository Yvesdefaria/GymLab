export const features = {
  ...
  steps: {
    title: 'Step counter',
    subtitle: 'Your daily activity with a goal and streaks.',
    today: 'Today',
    goalLabel: 'Daily goal',
    goalUnit: 'steps/day',
    recordAction: 'Log steps',
    ...
    pageTitle: 'Your Steps Today',
    weekSection: 'This week',
    weekSub: '{{count}} steps this week',
    weekGoal: 'Daily goal',
    weekEmpty: 'No steps this week.',
    ringAria: 'Today: {{count}} steps of {{goal}}',
    ringGoal: '/ {{goal}}',
    statSteps: 'Steps',
    heatmapDay: '{{date}}: {{count}} steps',
    heatmapNoData: 'No steps',
    heatmapHint: 'Tap a day to see details',
    heatmapLess: 'Less',
    heatmapMore: 'More',
    ...
    saveSteps: 'Save',
    recordCancel: 'Cancel',
    recorded: 'Steps saved',
    heatmapLabel: 'Monthly activity',
    heatmapEmpty: 'No activity this month.',
    streakEmpty: 'No streak yet: hit your goal today.',
    empty: 'No steps logged',
    emptyText: 'Log today\'s steps to start your streak.',
    strideInfo: 'Distance estimated with your stride (41.5% of your height).',
    sourceManual: 'Manual',
    sourcePhone: 'Phone',
    sourceWatch: 'Watch',
    ...
    achievements: {
      ...
      diezMilDia: { name: 'Ten thousand in one day', desc: 'Hit 10,000 steps in one day.' },
      racha7Dias: { name: '7-day streak', desc: 'Hit 10,000 steps 7 days in a row.' },
      racha30Dias: { name: '30-day streak', desc: 'Hit 10,000 steps 30 days in a row.' },
      cincuentaMilSemana: { name: 'Intense week', desc: 'Total 50,000 steps in a week.' },
      doscientosMilMes: { name: 'Endurance month', desc: 'Total 200,000 steps in a month.' },
      millonTotal: { name: 'Million steps', desc: 'Accumulate 1,000,000 steps overall.' },
      maraton: { name: 'Marathon', desc: 'Hit 42,000 steps in one day.' },
    },
  },
